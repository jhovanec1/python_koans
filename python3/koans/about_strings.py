...
It was the worst of times."
        self.assertEqual(True, len(string)==52)
...
world!
"""
        self.assertEqual(True, len(string)==15)
    ...
    def test_escaping_quotes_at_the_end_of_triple_quoted_string(self):
        string = """Hello "world\""""
        self.assertEqual(True, string=='Hello "world"')
    ...
    def test_plus_will_not_modify_original_strings(self):
        ...
        there = "world"
        string = hi + there
        self.assertEqual(True, hi=='Hello, ')
        self.assertEqual(True, there=='world')

    def test_plus_equals_will_append_to_end_of_string(self):
        hi = "Hello, "
        there = "world"
        hi += there
        self.assertEqual(True, hi == 'Hello, world')
    ...
    def test_plus_equals_also_leaves_original_string_unmodified(self):
        ...
        there = "world"
        hi += there
        self.assertEqual(True, original== 'Hello, ')

    def test_most_strings_interpret_escape_characters(self):
        string = "\n"
        self.assertEqual('\n', string)
        self.assertEqual("""\n""", string)
        self.assertEqual(True, len(string)==1)
